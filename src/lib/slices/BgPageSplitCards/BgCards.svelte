...
<li class="relative w-full px-6 py-8 md:px-12 md:py-16">
	<PrismicLink field={card.card_link}>
		...
		<div class="flex flex-col items-center justify-center rounded-xl bg-surface-800 min-h-64 px-8 py-8 text-xl md:px-12 md:py-12 transition-shadow duration-300 ease-in-out [@media(hover:hover)]:hover:shadow-lg [@media(hover:hover)]:hover:shadow-tertiary-600">
